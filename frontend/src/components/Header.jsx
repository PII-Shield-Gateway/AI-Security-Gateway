          ...
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <p className="max-w-3xl text-sm leading-6 text-slate-600 dark:text-slate-300 sm:text-base">
                외부 AI API 호출 전 기업 내부 자료의 개인정보를 자동 탐지·마스킹합니다.
              </p>
            </div>
            ...
            <div className="flex flex-wrap gap-2">
              {featureBadges.map((badge) => (
                <span
                  key={badge}
                  className="inline-flex items-center rounded-full border border-slate-200 bg-slate-50 px-3 py-1 text-xs font-medium text-slate-700 shadow-sm ring-1 ring-slate-200/60 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-200 dark:ring-slate-700/70"
                >
                  {badge}
                </span>
              ))}
